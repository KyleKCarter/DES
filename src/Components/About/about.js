    ...
    render() {
        return (
            <div className='content'>
                ...
                <iframe title="Doc's player frame" src="https://player.twitch.tv/?channel=drdisrespect" frameborder="0" allowfullscreen="true" scrolling="no" height="300" width="540"></iframe>
