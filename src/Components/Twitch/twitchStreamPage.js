...
class TwitchStreamPage extends Component {
    ...
    render() {
        ...
        return (
            <div className='page_content_twitch'>
                ...
                <div className='stream_content'>
                    <iframe title="Streamer's player frame" src={`https://player.twitch.tv/?channel=${display_name}`} frameborder="0" allowfullscreen="true" scrolling="no" className='twitch_stream_video_frame'></iframe>
                    <iframe title="Streamer's chat frame" src={`https://www.twitch.tv/embed/${display_name}/chat`} frameborder="0" scrolling="no" className='twitch_stream_chat_frame'></iframe>
                </div>
